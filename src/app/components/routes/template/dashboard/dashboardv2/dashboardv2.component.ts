...
export class Dashboardv2Component implements OnInit {
    ...
    constructor(public colors: ColorsService, public http: HttpClient) {
        http.get('assets/server/chart/barstackedv2.json').subscribe(data => this.barStackedData = data);
        http.get('assets/server/chart/splinev2.json').subscribe(data => this.splineData = data);
    }
